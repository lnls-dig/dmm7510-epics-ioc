...
EPICS_IOC_LOG_INET="$EPICS_IOC_LOG_INET" EPICS_IOC_LOG_PORT="$EPICS_IOC_LOG_PORT" EPICS_CA_MAX_ARRAY_BYTES="$EPICS_CA_MAX_ARRAY_BYTES" IPADDR="$IPADDR" IPPORT="$IPPORT" P="$P" R="$R" "$IOC_BIN" stDMM7510.cmd
