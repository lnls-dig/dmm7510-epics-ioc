...
\paragraph{} This manual provides an overview of the DCCT application and associated EPICS Process Variables. It is assumed that the reader is familiar with the basics of EPICS applications.
...
\section{Process Variables Description}\label{sec:process-variables}
	...
	\begin{longtable}{| m{3.0cm} m{4.5cm} m{7.0cm} |}
		...
		MeasTrg-Sts & ENUM: Unknown, External, InLevel, Software, None & \begin{tabular}{@{}m{6cm}@{}}
						...
						\end{tabular} \\ \hline
		% --- row ---
		TrgDelay-SP & FLOAT: Min=\SI{8}{\micro\second}, Max=\SI{100000}{\second} & \begin{tabular}{@{}m{6cm}@{}}
	    					Trigger delay. The trigger delay specifies the delay between the external or level based trigger and the measurement start.
						\end{tabular} \\ \hline
		% --- row ---
		TrgDelay-RB & FLOAT: Min=\SI{8}{\micro\second}, Max=\SI{100000}{\second} & \begin{tabular}{@{}m{6cm}@{}}
		...
		LowLimEnbl-Sts & BOOL: OFF, ON & \begin{tabular}{@{}m{6cm}@{}}
						...
						\end{tabular} \\ \hline
		% --- row ---
		Threshold-SP & FLOAT: Min=\SI{0}{\milli\ampere}, Max=\SI{2000}{\milli\ampere} & \begin{tabular}{@{}m{6cm}@{}}
	    					Current threshold. The current threshold value used by low current detection or level based triggering.
						\end{tabular} \\ \hline
		% --- row ---
		Threshold-RB & FLOAT: Min=\SI{0}{\milli\ampere}, Max=\SI{2000}{\milli\ampere} & \begin{tabular}{@{}m{6cm}@{}}
