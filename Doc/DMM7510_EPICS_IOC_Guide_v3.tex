...
\item Input is the measurement (if relative offset is being used, this is the relative offset value) \item Reference is the user-specified constant \end{itemize} \\
	...
	\subsection{Buffer operations}\label{pvgroup:buffer-operations}
		...
		\begin{tabular}{N}
			...
			TSP command: statsVar = buffer.getstats(defbuffer\textless n\textgreater-Mon) \\
			print(statsVar.mean)
		\end{tabular}
		...
		\begin{tabular}{N}
			...
			TSP command: statsVar = buffer.getstats(defbuffer\textless n\textgreater) \\
...
count is not changed. \\
		...
		\begin{tabular}{N}
			...
			TSP command: action, interval, hour = acal.schedule() \\
			print(action)
		\end{tabular}
		...
		\begin{tabular}{N}
			...
			TSP command: acal.schedule(ACalSchAct-Sts, \emph{value}, \emph{ACalSchHr-RB})
		\end{tabular}
		...
		\begin{tabular}{N}
			...
			TSP command: acal.schedule(ACalSchAct-Sts, ACalSchInt-Sts, \emph{value})
		\end{tabular}
