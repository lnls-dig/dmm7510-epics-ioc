	...
	\subsection{General}\label{pvgroup:general}
		...
		\begin{tabular}{N}
			...
			bool\{\begin{itemize}[noitemsep]
				...
				\item[] ON
			\end{itemize}\} \\
			Description: When set to 1 or \emph{ON}, this PV process \emph{EvLogNext-Mon}, causing it to read the oldest message in the event log. This PV is useful in user interfaces. \\
			TSP command: No command
		\end{tabular}
